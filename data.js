...
window.TRIP = {
  ...
  days: {
    ...
    2: { route: "喜迎旅店 ・ 鳳山 ・ 枋寮 ・ 金崙 ・ 臺東 ・ 花蓮", overview: "喜迎旅店 → 鳳山 → 枋寮 → 金崙 → 臺東 → 花蓮", color: "#6E9E9A", soft: "#E6F0EF", travelmode: "transit", spots: [
      ...
      { id: "fixed-10", shortLabel: "枋寮", time: "10:10–10:25", title: "抵達枋寮、寄放行李", tag: "🧳 行李房寄放", icon: "🎒", type: "transport", desc: "10:10 抵達枋寮，先到車站行李房寄放登機箱；貴重物品放入背包隨身攜帶。", q: "枋寮火車站" },
      ...
      { id: "fixed-24", shortLabel: "枋寮", time: "11:00–11:20", title: "枋寮韭菜盒子＆豬肉餡餅", tag: "🥟 在地銅板小吃", icon: "🥟", type: "food", meals: ["早餐", "午餐"], desc: "買韭菜盒子或豬肉餡餅墊胃，建議吃約五、六分飽；店家可能排隊或提早售完，沒買到就直接前往漁港。", q: "枋寮韭菜盒子 豬肉餡餅" },
      ...
      { id: "fixed-28", shortLabel: "金崙", time: "14:45–15:30", title: "LI.KA CAFE 力卡珈琲", tag: "☕ 部落風味午茶", icon: "☕", type: "cafe", desc: "品嚐刺蔥或馬告風味飲品、紅烏龍貝果、小米粽或小米酒粕甜點；抵達時可先詢問是否能暫放一個登機箱，不能寄放也不影響後續行程。", q: "LI.KA CAFE 力卡珈琲" },
      ...
      { id: "fixed-31", shortLabel: "臺東", time: "18:35–20:33", title: "自強 445 次｜臺東 → 花蓮", tag: "🚆 晚間北上", icon: "🚆", type: "transport", desc: "18:35 自臺東站出發，車上吃先前買好的晚餐，20:33 抵達花蓮。實際時間以 10/9 車票及當日班表為準。", q: "臺東火車站" },
