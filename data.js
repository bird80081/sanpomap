...
window.TRIP = {
  ...
  days: {
    ...
    3: { route: "Have Fun 225 ・ 崇德礫灘 ・ 新城老街 ・ 將軍府 ・ 花蓮站", overview: "Have Fun 225 → 取車（方案待定） → 崇德礫灘 → 新城 → 將軍府 → 花蓮站", color: "#86A474", soft: "#E9F0E2", travelmode: "driving", spots: [
      ...
      { id: "fixed-21", shortLabel: "花蓮站", time: "16:20–18:15", title: "還車、取行李 ＆ 臺鐵 285 次", tag: "🚆 EMU3000 賦歸", icon: "🚉", type: "transport", desc: "以 16:20 完成還車為目標，再回民宿取行李，17:15 前抵達花蓮站，可買晚餐與伴手禮。暫排 18:15 的 285 次返臺北，車票與發車時間待核對；若租 iRent，付款前確認折抵券已套用。", q: "花蓮火車站" }
    ]}
  },
  ...
  transitNote: "<b>臺東轉乘：</b>暫排 17:29 抵達、18:35 出發，18:20 回月台；便當售完就改買站內其他餐食。<br><br><b>行前待確認</b><br>① 車票：111、727、445、285 次的購票／劃位與當日時間；3005 次班表；441 次金崙→臺東已確認劃位，時間仍以票面為準。<br>② 租車：高雄取還車站點、花蓮汽車或機車的選擇及預約；兩張折抵券各自效期、連假適用及最低用車門檻。<br>③ 行李／住宿：枋寮寄物服務、金崙寄放備案、Have Fun 225 晚間入住與隔天寄放取件；兩晚訂房資訊再核對。<br>④ 餐食／景點：華僑市場晚間攤商、鼎倫最後點餐、力卡與邊境連假營業；崇德道路及海灘開放。Day 1 午餐、Day 2 早餐需先補妥。<br><br><b>折抵券操作：</b>還車流程選券 → 核對租金折抵 → 還車付款；每筆訂單一張，里程及其他費用另計。",
  stays: [
