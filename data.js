...
window.TRIP = {
  ...
  days: {
    ...
    3: { route: "Have Fun 225 ・ 崇德礫灘 ・ 新城老街 ・ 將軍府 ・ 花蓮站", overview: "Have Fun 225 → 取車（方案待定） → 崇德礫灘 → 新城 → 將軍府 → 花蓮站", color: "#86A474", soft: "#E9F0E2", travelmode: "driving", spots: [
      { id: "fixed-15", shortLabel: "花蓮住宿", time: "建議 08:30", title: "Have Fun 225 退房、寄放行李", tag: "🏡 今日出發點", icon: "🧳", type: "transport", desc: "先確認民宿寄放及領取行李時間，預計 09:00 取車。花蓮租車尚未定案：優先比較 iRent 汽車搭配另一張 90 分鐘券，Rilink X／在地油車機車為省錢備案。", q: "花蓮市國盛二街225號" },
      { id: "fixed-16", shortLabel: "取車待定", time: "09:00–09:20", title: "花蓮取車（汽車／機車待確認）", tag: "🚗 尚待預約", icon: "🚗", type: "transport", desc: "優先評估 iRent 汽車＋第 2 張 90 分鐘券；想省最多可選 Rilink X 或其他在地油車機車。先確認 10/10 車源、完整費用與券的效期／門檻，再決定；以下導航暫以花蓮站為集合點，預約後改成實際取車位置。", q: "花蓮火車站" },
      ...
      { id: "fixed-21", shortLabel: "花蓮站", time: "16:20–18:15", title: "還車、取行李 ＆ 臺鐵 285 次", tag: "🚆 已購票・已劃位", icon: "🚉", type: "transport", desc: "以 16:20 完成還車為目標，再回民宿取行李，17:15 前抵達花蓮站，可買晚餐與伴手禮。285 次已購票並完成劃位，暫排 18:15 返臺北，發車時間以票面為準；若租 iRent，付款前確認折抵券已套用。", q: "花蓮火車站" }
    ]}
  },
  transitTip: "鳳山至枋寮搭<b>3005 次區間快</b>，無對號座；Day 1 高雄取 iRent 自駕，Day 3 花蓮租車<b>尚未定案</b>：優先比較 iRent 汽車＋另一張 90 分鐘券，Rilink X／在地油車機車為備案。<b>連假車流多</b>，預留車程與停車緩衝。",
  transit: [
