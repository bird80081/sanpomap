...
window.TRIP = {
  ...
  days: {
    ...
    3: { route: "Have Fun 225 ・ 崇德礫灘 ・ 新城老街 ・ 將軍府 ・ 花蓮站", overview: "Have Fun 225 → 取 iRent 汽車 → 崇德礫灘 → 新城 → 將軍府 → 花蓮站", color: "#86A474", soft: "#E9F0E2", travelmode: "driving", spots: [
      { id: "fixed-15", shortLabel: "花蓮住宿", time: "建議 08:30", title: "Have Fun 225 退房、寄放行李", tag: "🏡 今日出發點", icon: "🧳", type: "transport", desc: "先確認民宿寄放及領取行李時間，完成退房後前往 iRent 取汽車，預計 09:00 取車；實際站點與預約待確認。", q: "花蓮市國盛二街225號" },
      ...
      { id: "fixed-21", shortLabel: "花蓮站", time: "16:20–18:15", title: "iRent 還車、取行李 ＆ 臺鐵 285 次", tag: "🚆 已購票・已劃位", icon: "🚉", type: "transport", desc: "以 16:20 完成還車為目標，再回民宿取行李，17:15 前抵達花蓮站，可買晚餐與伴手禮。285 次已購票並完成劃位，暫排 18:15 返臺北，發車時間以票面為準；iRent 還車付款前確認第 2 張 90 分鐘折抵券已套用。", q: "花蓮火車站" }
    ]}
  },
