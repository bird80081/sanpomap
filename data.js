...
window.TRIP = {
  ...
  days: {
    ...
    2: { route: "喜迎旅店 ・ 鳳山 ・ 枋寮 ・ 金崙 ・ 臺東 ・ 花蓮", overview: "喜迎旅店 → 鳳山 → 枋寮 → 金崙 → 臺東 → 花蓮入住 → 幽靈餐車 → 回民宿", color: "#6E9E9A", soft: "#E6F0EF", travelmode: "transit", spots: [
      ...
      { id: "fixed-32", shortLabel: "幽靈餐車", time: "21:20–22:10", title: "幽靈餐車｜花蓮宵夜", tag: "🍳 入住後吃宵夜", icon: "🍳", type: "food", desc: "先在 Have Fun 225 辦理入住、放好行李，再搭計程車前往吉安鄉建國路一段162號；10/9 晚上尚未取 iRent。可依食量點炸蛋、炒飯／炒麵或雞湯。暫排 21:20 抵達，車程與候位保留彈性；公開資訊列營業至 23:30，10/9 連假營業與最後點餐仍待確認。", q: "幽靈餐車 花蓮縣吉安鄉建國路一段162號" },
      { id: "fixed-33", shortLabel: "花蓮住宿", time: "約 22:30", title: "返回 Have Fun 225 休息", tag: "🏡 宵夜後回民宿", icon: "🌙", type: "stay", desc: "宵夜後搭計程車返回民宿休息；若候位較久，可改外帶回民宿，依實際用餐時間彈性返回。", q: "花蓮市國盛二街225號" }
    ]},
